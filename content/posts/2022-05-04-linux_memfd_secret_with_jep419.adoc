...
is a *Fedora release 35* with the kernel *5.16.20-200.fc35.x86_64*.
...
----
var linker = Linker.nativeLinker();
MethodHandle __errnoLocationMH = linker.downcallHandle(
        linker.defaultLookup().find("__errno_location").orElseThrow(),
        FunctionDescriptor.of(ValueLayout.ADDRESS)
);

int errno = ((MemorySegment) __errnoLocationMH.invoke()) // <1>
...
String errmsg = ((MemorySegment) strerror.invoke(errno)).reinterpret(Long.MAX_VALUE).getString(0);
----
