...
[source]
----
-XX:StartFlightRecording=settings=profile,delay=20s,duration=60s,name=MyRecording,filename=foo.jfr
----
...
At this time two configurations by defaut should appear
