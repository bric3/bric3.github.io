...
.JFR big picture
image::{image-assets}/jfr/java-flight-recorder-big-picture2.svg[align="center"]
...
.Thread Lanes
image::{image-assets}/jfr/startup-0-thread-lanes.png[align="center"]
...
image::{image-assets}/jfr/startup-0-threads-lanes-closer.png[align="center"]
...
.monitor blocked
image::{image-assets}/jfr/startup-1-threads-jedis-lock-event.png[align="center"]
...
image::{image-assets}/jfr/startup-1-threads-jedis-monitor-acquire-blocked.png[align="center"]
...
.jedis classloading
image::{image-assets}/jfr/startup-1-threads-jedis-monitor-blocked-stack.png[align="center"]
...
image::{image-assets}/jfr/startup-1-socketio-redis-port.png[align="center"]
...
image::{image-assets}/jfr/startup-1-socketio-redis.png[align="center"]
...
image::{image-assets}/jfr/startup-2-thread-lanes.png[align="center"]
...
image::{image-assets}/jfr/startup-2-stack-01.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-02.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-03.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-04.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-05.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-06.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-07.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-08.png[align="center"]
====
...
====
.Jackson's `PropertySerializerMap` initialization
image::{image-assets}/jfr/startup-2-stack-09.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-10.png[align="center"]
====
...
image::{image-assets}/jfr/startup-2-stack-11.png[align="center"]
====
...
image::{image-assets}/jfr/startup-3-C2-compiler.png[align="center"]
...
.Improved P99
image::{image-assets}/jfr/startup-3-grafana.png[align="center"]
...
.Revoke Bias locking
image::{image-assets}/jfr/startup-4-threads-revoke-biased-locks.png[align="center"]
...
.Before => after
image::{image-assets}/jfr/startup-5-before-after.png[align="center"]
...
.GC gaps
image:{image-assets}/jfr/startup-9-gc-pause-1.png[title="GC gap 1"] image:{image-assets}/jfr/startup-9-gc-pause-2.png[title="GC gap 2"]
...
image::{image-assets}/jfr/startup-9-thread-lanes-gc-pauses-effect.png[align="center"]
...
image::{image-assets}/jfr/jmc-java-application-view.png[align="center"]

.Garbage Collection view
image::{image-assets}/jfr/jmc-garbage-collection-view.png[align="center"]
