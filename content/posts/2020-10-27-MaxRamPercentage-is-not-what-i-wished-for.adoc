...
I’m not sure I had a proper expectation about what could have been `MaxRAMPercentage`, but nowadays I’m sure I don’t have any. Maybe the _soft max heap_ that is currently getting worked on.