...
But let's see how I build it, then let's look if it's possible to repurpose elements
...
This happend during this https://github.com/torvalds/linux/commit/607ca46e97a1b6594b29647d98a32d545c24bdff#diff-9a1cc27b54f86cc709009b1225d7579bc53ee715d133f6104e56782d3ec697da[commit]
...
When containers are stripped down and read-only, and you don't have the possibility
