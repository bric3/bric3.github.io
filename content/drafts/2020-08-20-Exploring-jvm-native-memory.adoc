...
Getting comfortable with memory of a (JVM) process is a tedious task
...
`Other` section of NMT.

.Exercise DIrectByteBuffer and NMT
[source, java]
----
// env -u JDK_JAVA_OPTIONS java -XX:NativeMemoryTracking=summary BDD.java 1 1
import java.nio.*;
...
<2> `DirectByteBuffer` use `malloc` underneath.


.10 x 1MiB
[source,role="secondary"]
----
$ env -u JDK_JAVA_OPTIONS java -XX:NativeMemoryTracking=summary BDD.java 10 1
nmt baseline:
839:
Baseline succeeded
nmt summary.diff:
...
-                     Other (reserved=10250KB +10240KB, committed=10250KB +10240KB)
                            (malloc=10250KB +10240KB #12 +10)
...
[source,role="secondary"]
----
$ env -u JDK_JAVA_OPTIONS java -XX:NativeMemoryTracking=summary BDD.java 20 100
nmt baseline:
898:
Baseline succeeded
nmt summary.diff:
...
-                     Other (reserved=409610KB +409600KB, committed=409610KB +409600KB)
                            (malloc=409610KB +409600KB #6 +4)
