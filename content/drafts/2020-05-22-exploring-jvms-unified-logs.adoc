...
should add tags for the type of GC, cms for CMS, zgc for ZGC, g1 for G1GC, shenandoah
for Shenandoah, etc.

And in that regard I think the new system lacks good default options for logging.
