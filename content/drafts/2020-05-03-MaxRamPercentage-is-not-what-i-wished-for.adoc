...
Some charts may however use the https://en.wikipedia.org/wiki/Binary_prefix[metric notation] (`1 KB = 1000 B`).
====
...
<2> `Heap` zone, note reserved and committed values are the same `4456448 KiB` here because our
