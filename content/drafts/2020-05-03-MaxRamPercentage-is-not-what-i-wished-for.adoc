...
https://openjdk.java.net/jeps/346[JEP-346].
...
In this local test serie, I'm using 3GB as a memory limit and I chose 70% for the heap percengtage.
...
of memory constraints `3 GiB`. And at 80%, `2.1 GiB`, of the same limit when
